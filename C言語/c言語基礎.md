...
* 文字列
  ...
  * 文字リテラルと文字列リテラル
    ...
    * 文字列
    ...
    ![image-20220711152959028](img/image-20220711152959028.png)
...
* ダブルポインタ
  ...
  * Exam2.2を復習すること
    ...
    void MatrixAddition(MatrixAddition(int (*result)[3][3], int (*matrixA)[3][3], int (*matrixB)[3][3])
    {
    	int* a;
    	int* b;
    	int *res;
    ...
    この考え方大事。関数の仮引数に変数として渡す際の渡し方もこれを意識すると変わってくる。visual studioの警告をきちんと確認すること

    ![image-20220711121102013](img/image-20220711121102013.png)
